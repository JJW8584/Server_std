...
{
	return ::WSASocket(AF_INET, SOCK_STREAM, IPPROTO_TCP, NULL, 0, WSA_FLAG_OVERLAPPED/*비동기 함수 사용 가능*/);
}
...
bool SocketUtils::BindAnyAddress(SOCKET socket, uint64 port)
{
