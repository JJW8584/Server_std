...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_C_RETURN_TO_ROOM] = [](PacketSessionRef& session, BYTE* buffer, int32 len) {	return HandlePacket<Protocol::C_RETURN_TO_ROOM>(Handle_C_RETURN_TO_ROOM, session, buffer, len);	};
